...
Welcome to `bioc2ri` contributor's guide.
...
If you experience bugs or general issues with `bioc2ri`, please have a look
...
You can help improve `bioc2ri` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`bioc2ri` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `bioc2ri`'s files. While this mechanism can
...
```
conda create -n bioc2ri python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/bioc2ri.git
   cd bioc2ri
   ```
...
5. Install [pre-commit]:
   ...
   `bioc2ri` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/bioc2ri
[issue tracker]: https://github.com/<USERNAME>/bioc2ri/issues
